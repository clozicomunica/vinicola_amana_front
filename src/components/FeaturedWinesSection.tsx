        ...
        {loading ? (
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute left-0 top-1/2 z-10 -translate-y-1/2 bg-[#89764b]/80 hover:bg-[#89764b] text-white p-2 rounded-full transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            ...
            <button
              onClick={handleNext}
              disabled={currentIndex >= featuredWines.length - getSlidesPerView()}
              className="absolute right-0 top-1/2 z-10 -translate-y-1/2 bg-[#89764b]/80 hover:bg-[#89764b] text-white p-2 rounded-full transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
            ...
            {/* Link para explorar todos os vinhos */}
